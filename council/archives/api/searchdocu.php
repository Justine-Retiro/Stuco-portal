...
$sql = "SELECT dt.*, 
            ...
            dt.branchmanager_status as branchmanager_status,
            dt.final_status as final_status,
            dt.adviserStatus as adviserStatus
        ...
        WHERE dt.sender_id = ? AND dt.sender_department = ? AND dt.on_process = false
...
$bind_result = $stmt->bind_param("isssssssssii", $sender_id, $sender_department, $searchTerm, $searchTerm, $searchTerm, $searchTerm, $searchTerm, $searchTerm, $searchTerm, $searchTerm, $offset, $items_per_page);
