...
if(!$isValidToken || !isAdminType($_SESSION['adminType']) || !isset($_SESSION['username']) || !isset($_SESSION["department"]) ) {
...
if(isset($_SESSION['timeout'])) {
    ...
    if($session_life > $inactive) {
        // End the session
        session_destroy();
        header("Location: ../../global_api/logout.php"); // Redirect to logout page
        exit();
    }
}
