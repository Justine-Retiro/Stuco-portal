...
switch ($admin_type) {
    case "Adviser":
        ...
        $stmt->bind_param("ssssssssssii", $_SESSION["department"], $_SESSION["department"], $searchTerm, $searchTerm, $searchTerm, $searchTerm, $searchTerm, $searchTerm, $searchTerm, $searchTerm, $offset, $items_per_page);
        break;
    case "Branch Manager":
    case "CSDL Director": 
    case "Marketing": 
